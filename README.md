...
3. Pillow and the Python Image Library (PIL) that is used in this project: [Github](https://github.com/python-pillow/Pillow) | [PyPI](https://pypi.org/project/pillow/)
